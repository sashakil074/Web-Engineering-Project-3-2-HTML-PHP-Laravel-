 ...
 <div class="max-w-md mx-auto bg-gray-100 shadow-lg rounded-lg overflow-hidden md:max-w-lg">
        <div class="md:flex">
            <div class="w-full p-4">
                <div class="relative"> <p style="text-align: center"> My Inbox<i class="fa fa-sms absolute right-3 top-4 text-gray-300">Search...</i></p> </div>
                <br>
                <br>
...
@else
   ...
   <div class="py-10 h-screen bg-gray-300 px-2">
    ...
    <div class="max-w-md mx-auto bg-gray-100 shadow-lg rounded-lg overflow-hidden md:max-w-lg">
        <div class="md:flex">
            <div class="w-full p-4">
            <div class="relative"> <p style="text-align: center"> My Inbox<i class="fa fa-sms absolute right-3 top-4 text-gray-300"></i></p> </div>
                <ul>
