...
<div class="col-sm-5 col-xs-6 tital " >Position:</div><div class="col-sm-7"> {{$data->Position}}</div>
  <div class="clearfix"></div>
<div class="bot-border"></div>

<div class="col-sm-5 col-xs-6 tital " >Working Place:</div><div class="col-sm-7">{{$data->Work_place}}</div>
