...
<body>
  ...
  <div class="container signin">
    ...
    <form action="patienthome" method="post">
      @csrf
      <input type="text" name="Username" class="form-control" placeholder="Username" data-rule="required" data-msg="Please enter Username" autocomplete="off">
      ...
      @endif
      <br>
      <input type="password" name="Password" class="form-control" placeholder="Password" data-rule="required" data-msg="Please enter a Password" autocomplete="off">
      ...
      <p style="color: white">Not a Member? <a href="/patientregistration">Register Now</a>.</p>
  </div>
  </form>
