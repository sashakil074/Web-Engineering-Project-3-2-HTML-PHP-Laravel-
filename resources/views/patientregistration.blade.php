...
<body>
  ...
  <div class="container signin">
    ...
    <form action="patientregistration" method="post">
      ...
      <span class="text-danger">
        <br> {{$errors->first('Birth_year')}}
      </span>
      @endif

      <!-- <input type="text" name="Division" class="form-control" placeholder="Division">-->
      <select class="form-control" name="Division" style="width: 60%;height:32px;">
      ...
      @endif
      <br>
      <input type="text" name="Contact" class="form-control" placeholder="Contact No" autocomplete="off">
